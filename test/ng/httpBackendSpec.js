...
describe('$httpBackend', function() {
  ...
  var $backend, $browser, $engineQueue, $jsonpCallbacks,
  ...
  beforeEach(inject(function($injector) {
    ...
    $backend = createHttpBackend($browser, createMockXhr, $engineQueue, $browser.defer, $jsonpCallbacks, fakeDocument);
  ...
  it('should call $xhrFactory with method and url', function() {
    ...
    $backend = createHttpBackend($browser, mockXhrFactory, $engineQueue, $browser.defer, $jsonpCallbacks, fakeDocument);
    $backend('GET', '/some-url', 'some-data', noop);
